...
<html>
 ...
 <body>
   <header class="well bg-opacity col-md-10 col-md-offset-1">
     <h1 class="text-center">Bienvenue </h1><h3 class="text-center">dans l'agence de voyage du cargo qui fuit</h3>
     ...
     <div class="panel-body">
       <div class="col-sm-6 col-sm-offset-3">
         <form class="form-group" method="post" action="agence.php">
           ...
           <label>Nom :</label><input type="text" name="nom" id="nom" placeholder="nom" required="requis" /><br>
           <label>Prénom :</label><input type="text" name="prenom" id="prenom" placeholder="prénom" required="requis"/><br>
           <div class="radio"><input type="radio" name="voyage-excursion" id="voyage-excursion" value="voyage" required="bouh"/></div><label>Voyage </label><br>
           <div class="radio"><input type="radio" name="voyage-excursion" id="voyage-excursion" value="excursion"/></div><label>Excursion </label><br>
           <input type="submit" value="Suite" id="submit-button" /></div>
         </form>
       </div>
     </div>
